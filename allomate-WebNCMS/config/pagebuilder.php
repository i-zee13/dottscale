...
return [
    ...
    'website_manager' => [
        ...
        'class' => App\Http\Controllers\WebsiteManager::class,
        'url' => '/cms/admin'
    ],
    ...
    'pagebuilder' => [
        ...
        'actions' => [
            'back' => '/admin/listPages'    // URL to a table overview of all pages
        ]
    ],
    ...
    'theme' => [
        ...
        'folder' => base_path('themes'),//,resource_path('views/themes')
        'folder_url' => '/themes',
        'active_theme' => 'demo'
    ],
