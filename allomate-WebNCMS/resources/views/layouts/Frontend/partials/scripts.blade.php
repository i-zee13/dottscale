@verbatim
<script src="/js/frontend/jquery-3.4.0.min.js"></script>
    <script src="/js/frontend/jquery.mCustomScrollbar.min.js"></script>
    <script src="/js/frontend/custom/contact-form.js"></script>
    <script src="/js/frontend/custom/subscription-form.js"></script>
                                    ...
                                    <div>
                                        <a href="${project.route ? project.route : 'javascript:void(0);'}" class="flex flex-col justify-center items-stretch mx-auto relative overflow-hidden no-underline group">
                                            ...
                                            <div class="relative flex justify-center items-center overflow-hidden rounded-[6px]">
                                                <!-- Logo Overlay -->
                                                <div
                                                    class="absolute w-full h-full bg-[#212529a1] cursor-pointer z-[1] opacity-100 hover:opacity-0 transition-opacity duration-300">
                                                        ...
                                                        <div class="absolute bottom-[10px] sm:bottom-[20px] left-[10px] sm:left-[20px] z-[20] group-hover">
                                                            ...
                                                            <div title="Read More"
                                                                ...
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22"
                                                                    class="bi bi-arrow-right-short text-[#212529]" viewBox="0 0 16 16" fill="currentColor">
                            ...
                            <div class="project-card">
                                <figure itemscope itemtype="http://schema.org/ImageObject">
                                    <img width="100" height="100" src="/${work.thumbnail}"
                                        alt="DottScale Works Images" itemprop="contentUrl">
                                    <figcaption>
                                        <small>${wo}</small>
        ...
        function allBlogsListing(blogs) {
                                ...
                                <div class="flex flex-col justify-between w-full">
                                    ...
                                    <div>
                                        ...
                                        <div title="Read More"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22"
                                                class="bi bi-arrow-right-short text-[#212529]" viewBox="0 0 16 16"
                                                fill="#000">
                                                <path fill-rule="evenodd"
                                                    d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8">
                                                </path>
                                ...
                                <div class="relative overflow-hidden no-underline rounded-[6px] z-[10] box-shadow">
                                    ...
                                    <div class="absolute bottom-[10px] sm:bottom-[20px] left-[10px] sm:left-[20px] z-[20] group-hover">
                                        ...
                                        <div title="Read More" class="group-hover:w-[70px] bg-bodybg rounded-[6px] w-[40px] h-[40px] flex items-center justify-center  transition-all duration-300 ease-in-out">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" class="bi bi-arrow-right-short text-[#212529]" viewBox="0 0 16 16" fill="currentColor">
            ...
            <div class="flex items-center pt-3 text-white hover:text-secondary cursor-pointer prev-page"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor"
                    class="bi bi-arrow-left-short text-[#FFB237]" viewBox="0 0 16 16">
                    <path fill-rule="evenodd"
            ...
            <div class="flex items-center pt-3 text-white hover:text-secondary cursor-pointer next-page"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22"
                    class="bi bi-arrow-right-short text-[#FFB237]" viewBox="0 0 16 16" fill="currentColor">
                    <path fill-rule="evenodd"
                        d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8">
                    </path>
                </svg>
                            ...
                            item: function(blog) {
                                ...
                                return `<div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                        <article class="card-our-blogs" itemscope itemtype="http://schema.org/BlogPosting">
                                            <figure itemscope itemtype="http://schema.org/ImageObject">
                                                <img width="100" height="100" src="${blog.after_header_image}" onerror="this.onerror=null;this.src='/images/blog-01.jpg';" alt="DottScale Blog Image" title="${blog.title}" itemprop="image">
                                                <figcaption>
                                                    <div class="row m-0">
                                                        <div class="col">
