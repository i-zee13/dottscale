                    ...
                    <div class="mil-menu-right-frame text-body contact-page-div">
                        <div class="mil-menu-right">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-6">
                                <div>
                                    <div class="title-menu text-white"> Say Hello </div><a href="tel:+1 (512) 564-8959" class="mb-0 text-base font-medium tracking-[1px] company_phone IDMFQW14IC4XUGW4">+1 (512) 564-8959</a><br><a href="mailto:contact@dottscale.com" class="company_email IDMFQW14IC1E6CF5">contact@dottscale.com</a>
                                </div>
                                <div>
