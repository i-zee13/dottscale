                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <form id="saveCityForm" style="display: none">
                                        ...
                                        <input type="text" name="hidden_city_state_id" id="hidden_city_state_id"
                                            hidden />
                                        <div id="floating-label" class="card p-20 top_border mb-3">
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="row tabs-div" style="display: none">
        <div class="col-lg-12">
            <div class="header-tabs mb-0 position-relative">
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <a class="nav-item nav-link" id="nav-province-tab" data-toggle="tab" href="#nav-province"
                        role="tab" aria-controls="nav-province" aria-selected="false">Province/State <span
                            class="_cus-val total_states">
                        </span></a>
                ...
                <button type="button" id="productlist01" class="btn add_button openDataSidebarForAddingCountries"><i
                        class="fa fa-plus mr-1"></i> <span>Add
                        New</span></button>
