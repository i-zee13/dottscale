...
<div class="row mt-2 mb-3">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6">
        <ol class="breadcrumb">
            <li><a href="javascript:void(0);"><span>Route List</span></a></li>
        ...
        <div class="card">
            ...
            <div class="body">
                <ul class="sortable" class="list-group subMenu" style="display: block">
                    ...
                    <li
                        style="height: 300px; overflow: auto; margin-bottom: 20px; width: 30%; display: inline-block; margin-left: 10px; float: left; padding-bottom: 10px;font-size:13px">
                        <span
                            style="cursor: pointer; background: #fafafa; padding: 0px; margin: 0px; height: 50px; text-align: center; line-height: 50px; border: 1px solid #244d80; text-transform: uppercase; font-weight: bold; display: block;"
                        ...
                        <div class="form-group p-b-10 p-t-10">
                            <ul class="sortable" class="list-group subMenu">
                                ...
                                <li class="addNewSubMob"
                                    style="text-align: center; background: #244d80; color: white; font-weight: bold; padding:8px;"
                                    class="list-group-item">
                                    <label parent-module="{{ $item['parent_module'] }}"
                                        style=" cursor: pointer; font-size: 14px; font-weight: bold; float: left; margin-bottom: 0;"
                                        for="dbV1" class="lab-medium deleteParentMod">DELETE</label>
                                    <label style="font-size: 14px; width: 150px; margin-bottom: 0;" for="dbV1" class="lab-medium">ADD
                                        NEW</label>
                                    <label style="cursor: pointer; font-size: 14px; font-weight: bold; float: right; margin-bottom: 0;"
