...
@section('content')
    <div class="row mt-2 mb-3">
        <div class="col-lg-6 col-md-6 col-sm-6">
            <h2 class="_head01">Terms of Use <span> Management</span></h2>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6">
            <ol class="breadcrumb">
    ...
    <form id="SavePrivacyForm" enctype="multipart/form-data">
        @csrf
        <input type="hidden" id="static_id" name="static_id" value="{{ @$terms->id }}">
        <input type="hidden" id="page_id" value="2" name="page_id">
        <div class="row">
            <div class="col-12 mb-30">
                <div class="card">
                    ...
                    display: block; height:400px;">
                        ...
                        <textarea id="ckeditor">{{ @$terms->document }}</textarea>
                    </div>
                    @php
                        $metaTags = @$terms->page_meta_tags ? json_decode($terms->page_meta_tags, true) : [];
                    @endphp
