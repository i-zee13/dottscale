...
@section('content')
    ...
    <div class="row _user-TS">
        <div class="col-md-12 _dashTOP"> <img class="_user_Pimage" src="{{GetActiveGuardDetail()->picture ? GetActiveGuardDetail()->picture : '/images/avatar.svg'}}" alt="">
            <h2 class="_head01">{{ $message }}, Mr.{{ GetActiveGuardDetail()->name }}</h2>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card mt-0">
                    ...
                    <h4>New<span> Inquiries</span></h4>
                    <h2 class="digit">{{ @$todayInquiries }} </h2>
    ...
    <div class="col-12 h_dash">
        <div class="row">
            ...
            <div class="col-4"><a href="{{ route('admin.inquiries') }}"><img
                    ...
                    <h2 class="HD-title">Inquiries <span class="f-light">list </span></h2>
                </a> </div>
