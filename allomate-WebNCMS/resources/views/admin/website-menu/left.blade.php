        ...
        <div class="col-md-12">
            <div class="card">
                <div class="header">
                    <div class="row">
                        <div class="col-6">
                            <h2 class="_head03 font18 border-0 pb-0 new_block">Left <span>Menu</span></h2>
                        </div>
                ...
                <div class="body">
                    ...
                    <div class="col-md-12 p-0 menu-row sortable" id="">
                        @if (@$record)
                            @foreach ($record as $site_menu)
                                ...
                                <div class="sortable-moves singleMenu delete_row_{{ $uniqueKey }}"
                                    id="{{ $uniqueKey }}">
                                    <div class="col-12">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <select class="custom-select custom-select-sm menuSelect formselect"style="width: 100%!important;">
                                                        ...
                                                        @foreach ($pages as $page)
                                                            <option value="{{ $page->url }}"
                                                                {{ $page->url == $site_menu['url'] ? 'selected' : '' }}>
                                                                {{ $page->title }}
                                                            </option>
                                                        @endforeach
                                                        @foreach ($new_pages_cat as $new_page)
                                                            <option value="{{ $new_page->url }}"
                                                                {{ $new_page->url == $site_menu['url'] ? 'selected' : '' }}>
                                                                {{ $new_page->title }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col pr-0">
                                                    <input type="text" class="form-control input-style"
                                                        value="{{ $site_menu['title'] }}" name="title"
                                                        id="tier_one_title_{{ $uniqueKey }}" placeholder="title here">
                                                </div>
                                                <div class="col pr-0">
                                                    <input type="text" class="form-control input-style"
                                                        placeholder="url here" value="{{ $site_menu['url'] }}"
                                                        name="url" id="tier_one_url_{{ $uniqueKey }}">
                                                </div>
                                                <div class="col-2" style="padding-top:5px">
                                                    <div class="custom-control custom-checkbox mr-sm-2 PageCheckbox font13">
                                                        <input type="checkbox" name="new_window"
                                                            ...
                                                            id="tier_one_new_window_{{ $uniqueKey }}"
                                                            value="{{ $site_menu['new_window'] }}"
                                                            {{ $site_menu['new_window'] ? 'checked' : '' }}>
                                                        <label class="custom-control-label"
                                                            for="tier_one_new_window_{{ $uniqueKey }}">New
                                                            Window?</label>
                                                    </div>
                                                </div>
                                                <div class="col-auto position-relative">
                                                    <button type="button" id="{{ $uniqueKey }}"
                                                        class="btn delListPO delete_row" title="Delete"><i
                                            ...
                                            <div class="addPackagingOption">
                                                <div class="row">
                                                    <div class="col-12 position-relative PB-20 newSecondTierPlace sortable">
                                                        ...
                                                        @if ($site_menu['sub_menu'])
                                                            @foreach ($site_menu['sub_menu'] as $sub_menu)
                                                                @php
                                                                    $length = rand(8, 10);
                                                                    $uniqueKey = str_pad(
                                                                        rand(0, (int) pow(10, $length) - 1),
                                                                ...
                                                                <div
                                                                    class="sortable-moves   secondTierIterate delete_row_{{ $uniqueKey }}">
                                                                    <div class="col-12 ">
                                                                        <div class="PackagingOption second_tier mb-0 "
                                                                            ...
                                                                            <div class="row  ">
                                                                                <div class="col-4 pr-0 ">
                                                                                    <select
                                                                                        class="custom-select custom-select-sm menuSelect formselect"style="width: 100%!important;">
                                                                                        <option value="">Select Menu
                                                                                        </option>
                                                                                        @foreach ($pages as $page)
                                                                                            <option
                                                                                                value="{{ $page->url }}"
                                                                                                {{ $page->url == $sub_menu['url'] ? 'selected' : '' }}>
                                                                                                {{ $page->title }}
                                                                                            </option>
                                                                                        @endforeach
                                                                                        @foreach ($new_pages_cat as $new_page)
                                                                                            <option
                                                                                                value="{{ $new_page->url }}"
                                                                                                {{ $new_page->url == $sub_menu['url'] ? 'selected' : '' }}>
                                                                                                {{ $new_page->title }}
                                                                                            </option>
                                                                                        @endforeach
                                                                                    </select>
                                                                                ...
                                                                                <div class="col-3"
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <input type="checkbox"
                                                                                            name="new_window"
                                                                                            class="custom-control-input"
                                                                                            value="{{ $sub_menu['new_window'] }}"
                                                                                            id="tier_two_new_window_{{ $uniqueKey }}"
                                                                                            {{ $sub_menu['new_window'] ? 'checked' : '' }}>
                                                                                        <label class="custom-control-label"
                                                                                            for="tier_two_new_window_{{ $uniqueKey }}">New
                                                                                            Window ?</label>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="col-auto position-relative">
                                                                                    <button type="button"
                                                                                        id="{{ $uniqueKey }}"
                                                                                        class="btn delListPO delete_row"
                                                                                        title="Delete"><i
                                                                                            class="fa fa-trash-alt"></i></button>
                                                                                    {{-- <button type="button"
                                                                                        class="btn editListPO"
                                                                        ...
                                                                        <div class="collapse"
                                                                            id="sub_subMenu{{ $collapse_id }}">
                                                                            <div class="addPackagingOption"
                                                                                style="border: solid 1px #e0e0e0;">
                                                                                <div class="row">
                                                                                    <div
                                                                                        class="col-12 position-relative thirdTierPlace sortable">
                                                                                        <div class="row m-0">
                                                                                            <div
                                                                                                class="col mt-auto mb-auto pl-0">
                                                                                                <strong class="font16">
                                                                                                    Sub-Submenu</strong>
                                                                                            </div>
                                                                                            <div
                                                                                                class="col-auto new_third_tier">
                                                                                                <button type="submit"
                                                                                                    class="btn btn-primary add-sub-m"><i
                                                                                                        class="fa fa-plus"></i></button>
                                                                                            </div>
                                                                                        </div>
                                                                                        @if (@$sub_menu['sub_SubMenu'])
                                                                                            @foreach ($sub_menu['sub_SubMenu'] as $sub_secondary_menu)
                                                                                                <div
                                                                                                    class="sortable-moves thirdTierIterate delete_row_{{ $uniqueKey }}">
                                                                                                    <div class="col-12  ">
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <select
                                                                                                                        ...
                                                                                                                        @foreach ($pages as $page)
                                                                                                                            <option
                                                                                                                                value="{{ $page->url }}"
                                                                                                                                {{ $page->url == $sub_secondary_menu['url'] ? 'selected' : '' }}>
                                                                                                                                {{ $page->title }}
                                                                                                                            </option>
                                                                                                                        @endforeach
                                                                                                                        @foreach ($new_pages_cat as $new_page)
                                                                                                                            <option
                                                                                                                                value="{{ $new_page->url }}"
                                                                                                                                {{ $new_page->url == $sub_secondary_menu['url'] ? 'selected' : '' }}>
                                                                                                                                {{ $new_page->title }}
                                                                                                                            </option>
                                                                                                                        @endforeach
                                                                                                                    </select>
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <input
                                                                                                                        ...
                                                                                                                        class="form-control input-style "
                                                                                                                        name="title"
                                                                                                                        value="{{ $sub_secondary_menu['title'] }}"
                                                                                                                        id="tier_three_title_{{ $uniqueKey }}"
                                                                                                                        placeholder="title here">
                                                                                                                </div>
                                                                                                                <div
                                                                                                                    class="col pr-0">
                                                                                                                    <input
                                                                                                                        ...
                                                                                                                        class="form-control input-style"
                                                                                                                        name="url"
                                                                                                                        value="{{ $sub_secondary_menu['url'] }}"
                                                                                                                        id="tier_three_url_{{ $uniqueKey }}"
                                                                                                                ...
                                                                                                                <div class="col-3"
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        ...
                                                                                                                        <input
                                                                                                                            ...
                                                                                                                            name="new_window"
                                                                                                                            class="custom-control-input"
                                                                                                                            value="{{ $sub_secondary_menu['new_window'] }}"
                                                                                                                            id="tier_three_new_window_{{ $uniqueKey }}"
                                                                                                                            {{ $sub_secondary_menu['new_window'] ? 'checked' : '' }}>
                                                                                                                        <label
                                                                                                                            class="custom-control-label"
                                                                                                                            for="tier_three_new_window_{{ $uniqueKey }}">New
                                                                                                                            Window
                                                                                                                            ?</label>
                                                                                                                    </div>
                                                                                                                </div>
                    ...
                    <div class="col-12 PT-20 text-center">
                        <button type="button" class="btn btn-primary save_web_menu">Save</button>
