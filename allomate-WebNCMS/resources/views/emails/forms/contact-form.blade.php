			...
			<tr>
				...
				border-radius: 18px;">
						<tbody>
										...
										<tbody>
											...
											<tr>
												<td style="font-family:'Lato', sans-serif; font-weight: 600;  font-size:22px; color:#000;padding-left: 20px; padding-right: 20px;" align="center" valign="top" class="editable">
													<multiline>New Contact Form Submission</multiline>
												</td>
											</tr>
											<tr>
												<td height="10"></td>
											...
											<tr>
												<td style="font-family:'Open Sans', sans-serif;font-size:14px; color:#000; padding-left: 20px; padding-right: 20px;" align="center" valign="top" class="editable">
													<multiline>A new Contact Form Submission has been received with the following details</multiline>
												</td>
											</tr>
											<tr>
												<td height="20"></td>
							...
							<tr>
								<td style="padding-left:20px; padding-right: 20px;">
									<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin: 0 auto; background-color:#001e35; border-radius: 18px;">
										<tbody>
											<tr>
												<td height="15px"></td>
											</tr>
										...
										padding-left:20px; padding-right: 20px;">
													<div class="editable-text" align="center" style="color:white">Copyright © {{date('Y')}} <a href = "{{ env('APP_URL') }}" alt="{{env('APP_NAME')}}" >{{env('APP_NAME')}}</a> all rights reserved.</div>
												</td>
											</tr>
											<tr>
												<td height="15px"></td>
