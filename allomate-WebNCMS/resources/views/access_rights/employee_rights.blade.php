                ...
                <div class="_left-filter pt-0 AccRights">
                    <div class="container">
                        <form style="width: 100%" id="saveRightsForm">
                            ...
                            <input type="hidden" value="{{json_encode(@$employees)}}" class="employee_list" id="employee_list">
                                ...
                                <div class="col-12">
                                    <div id="floating-label" class="card p-20 top_border mt-3 mb-3" style="width: 100%;">
                                        ...
                                        <div class="form-wrap p-0">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <select name="employee_id" class="form-control" class="employee_id">
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
...
<div class="row mt-2 mb-3">
    <div class="col-lg-6 col-md-6 col-sm-6">
        <h2 class="_head01">Employees  <span> Rights Management</span></h2>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-6">
        <ol class="breadcrumb">
        ...
        <div class="card">
            <div class="header">
                <a class="btn add_button openDataSidebarForAddingAccessRights"><i class="fa fa-plus"></i> New Access
                    Rights</a>
                <h2>Employees Access Rights List</h2>
            </div>
...
@push('js')
<script src="/js/custom/employee_access_rights.js"></script>
@endpush