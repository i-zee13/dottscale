<nav class="navbar navbar-expand  static-top">
    <a class="hamburger" href="javascript:void(0);" id="sidebarToggle"><i class="fas fa-bars"></i></a>
    <a class="_logo" href="/"><img src="/images/sell-360.svg" alt="" /></a>
    <ul class="navbar-nav ml-auto top_nav">
        <li class="nav-item TM_icon">
            <a class="nav-link" href="javascript:void(0);"><img src="/images/q-link-icon.svg" alt="" /></a>
        </li>
        <li class="nav-item TM_icon">
            <a class="nav-link" href="javascript:void(0);"><img src="/images/settings-icon.svg" alt="" /></a>
        </li>
        <li class="nav-item TM_icon dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="javascript:void(0);" id="NotiFications" role="button" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right notiF" aria-labelledby="NotiFications">
                ...
                <a href="javascript:void(0);"><img src="{{ URL::to('/storage/company').'/'.$notifications->picture}}" class="NU-img"
        ...
        <li class="nav-item dropdown no-arrow">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="/admin/profile/{{ Auth::user()->id }}"><i class="fa fa-user"> </i> Profile</a>
                <a class="dropdown-item" href="javascript:void(0);"><i class="fa fa-cogs"> </i> Settings</a>
