<ul class="sidebar navbar-nav toggled sidebar-navigation">
    ...
    <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="javascript:void(0);" id="navi-l1" role="button" data-toggle="dropdown"
        ...
        <div class="dropdown-menu" aria-labelledby="navi-l1">
            ...
            <a class="dropdown-item" href="/register">investors List</a>
            @endif
    ...
    <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="javascript:void(0);" id="navi-l2" role="button" data-toggle="dropdown"
            aria-haspopup="true" aria-expanded="false">
    ...
    <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="javascript:void(0);" id="navi-l3" role="button" data-toggle="dropdown"
            aria-haspopup="true" aria-expanded="false">
    ...
    <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="javascript:void(0);" id="navi-17" role="button" data-toggle="dropdown"
            aria-haspopup="true" aria-expanded="false">
