...
class ProfileController extends Controller
{
    ...
    {
        $designation    =   DB::table('designations')->where('id',GetActiveGuardDetail()->designation)->first();
        $reporting_to   =   User::where('reporting_to',GetActiveGuardDetail()->reporting_to)->first();
        return view('admin.profile.index',compact(['designation','reporting_to']));
    }
