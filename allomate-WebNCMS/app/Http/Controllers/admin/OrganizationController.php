...
class OrganizationController extends Controller
{
   public function index()
   {
      ...
      return view('admin.organization.index', compact('data'));
   }
   public function store(Request $request)
   {
      ...
      $validator       =   $this->validate($request,[
         ...
         'notification_received_email'    => 'required',
      ]);
      ...
      $data->behance_link     =   $request->behance_link;
      $data->dribble_link     =   $request->dribble_link;
      $data->clutch_link      =   $request->clutch_link;
      ...
      $data->page_meta_tags   =   $seo;
      $data->notification_received_email      =   $request->notification_received_email;
